...
namespace olympia
{
    ...
    private:
        ...
        sparta::Counter             num_arith_;         // Number of flushes
        sparta::Counter             num_branch_;        // Number of flushes
        sparta::Counter             num_load_;          // Number of flushes
        sparta::Counter             num_store_;         // Number of flushes
        std::vector<int> num_compress_;
